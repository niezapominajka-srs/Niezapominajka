...
for card in cards_validated:
    ...
    card_pair_path['i'] = Path.joinpath(card_dir, f'{card}.i')
    card_pair_path['f'] = Path.joinpath(card_dir, f'{card}.f')
    card_pair_path['b'] = Path.joinpath(card_dir, f'{card}.b')
